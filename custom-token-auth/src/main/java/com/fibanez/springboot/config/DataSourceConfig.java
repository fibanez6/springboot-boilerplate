package com.fibanez.springboot.config;
...
public class DataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "com.fibanez.springboot.domain.dto" });
    ...
    private Properties jpaProperties() {
        ...
        properties.put("hibernate.hbm2ddl.auto", environment.getRequiredProperty("spring.jpa.properties.hibernate.ddl-auto"));
